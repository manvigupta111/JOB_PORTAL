...
import { Download, BriefcaseBusiness, School, Boxes } from "lucide-react";
import useFetch from "@/hooks/use-fetch.tsx";
import { updateApplication } from "@/api/api-applications.tsx";
        ...
        {isCandidate ? (
          ...
          <Select
            ...
            <SelectTrigger className={`w-52`}>
              <SelectValue placeholder="ApplicationStatus" />
            </SelectTrigger>
            <SelectContent>
